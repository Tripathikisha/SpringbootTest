...
public class MailHandlerBase {
    ...
    public void sendMail()
    {
        ...
        try {
            ...
            mailMessage.setFrom(MailConstants.APP_PASSWORD);
            mailMessage.setSubject("Try to Mailing class");
            mailMessage.setRecipient(Message.RecipientType.TO, new InternetAddress("tripathi.kishan10@gmail.com"));
            mailMessage.setText("Kishan is trying to teach mailing through java!!!");
